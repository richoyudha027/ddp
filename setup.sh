...
echo "# ———————————————————————————————————————————————————————————————"
echo "OMP_NUM_THREADS=4 torchrun --nproc_per_node=1 train_ddp_unet.py \\"
...
echo "# ———————————————————————————————————————————————————————————————"
echo "OMP_NUM_THREADS=4 torchrun --nproc_per_node=2 train_ddp_unet.py \\"
...
echo "# ———————————————————————————————————————————————————————————————"
echo "OMP_NUM_THREADS=4 torchrun --nproc_per_node=4 train_ddp_unet.py \\"
