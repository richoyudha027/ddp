...
if __name__ == "__main__":
    ...
    # unet
    unet = UNet(4, 4, channels, deep_supervision=True, ds_layer=4, **block_kwargs)
    # print(unet)
    unet.eval()
    segs = unet(x)
    print(segs.shape)
    ...
    # multi-encoder unet
    mencoder_unet = MultiEncoderUNet(4, 4, channels, deep_supervision=True, ds_layer=4, **block_kwargs)
    # print(mencoder_unet)
